...
folder_name = '/media/ssd/right_ear_click_train_slow_aep_'+str(int(time.time()*1000000.0))
...
s = mixer.Sound('pip_train_brainstem.wav')
...
prev_time = 0
prev_tuple = 0
stop_time = time.time()+195

p = Popen(['python', 'aep/play_click_train_slow.py'])
#sth.start()
