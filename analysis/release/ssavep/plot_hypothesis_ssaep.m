...
for i = 1:size(CM, 1)
  switch (i)
    case 1
      ratio_harmonic = spline([0 0.25 0.5 0.75 1], [0.3 0.95 0.55 0.15 0], f_harmonic);
    case 2
      ratio_harmonic = spline([0 0.25 0.5 0.75 1], [0.4 1.3 0.45 0.20 0], f_harmonic);
    case 3
      ratio_harmonic = spline([0 0.25 0.5 0.75 1], [0.5 1.1 0.5 0.13 0], f_harmonic);
    case 4
      ratio_harmonic = spline([0 0.25 0.5 0.75 1], [1 2.6 1.0 0.3 0], f_harmonic);
  end
...
%patch([0 1 1 0], [1e-1 1e-1 1e-2 1e-2], 'k', 'clipping', 'off');
