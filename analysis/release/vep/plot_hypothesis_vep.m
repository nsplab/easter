...
for i = 1:size(CM, 1)
  switch (i)
    case 1
      chData_trial_averaged = -0.015 * normpdf(time_axis, -0.25, 0.100) ...
                              +0.030 * normpdf(time_axis,  0.40, 0.040) ...
                              +0.050 * normpdf(time_axis,  0.40, 0.210) ...
                              -0.020 * normpdf(time_axis,  0.73, 0.080)
    case 2
      chData_trial_averaged = -0.010 * normpdf(time_axis, -0.25, 0.090) ...
                              +0.015 * normpdf(time_axis,  0.40, 0.050) ...
                              +0.045 * normpdf(time_axis,  0.40, 0.220) ...
                              -0.015 * normpdf(time_axis,  0.73, 0.090)
    case 3
      chData_trial_averaged = -0.005 * normpdf(time_axis, -0.18, 0.080) ...
                              +0.020 * normpdf(time_axis,  0.37, 0.040) ...
                              +0.040 * normpdf(time_axis,  0.42, 0.210) ...
                              -0.010 * normpdf(time_axis,  0.73, 0.090)
    case 4
      chData_trial_averaged = -0.015 * normpdf(time_axis, -0.20, 0.070) ...
                              +0.050 * normpdf(time_axis,  0.35, 0.030) ...
                              +0.070 * normpdf(time_axis,  0.40, 0.200) ...
                              -0.030 * normpdf(time_axis,  0.75, 0.080)
  end
...
%set(gca, 'XTick', [0 1]);
%%set(gca, 'XTickLabel', {0, '=>'}, 'Interpreter', 'LaTeX');
...
%my_xticklabels(gca, [0, 1], {0, '\rightarrow'});
