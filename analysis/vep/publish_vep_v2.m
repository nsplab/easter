...
function [] = publish_vep_v2(data, cleanDigitalIn, fs, publication_quality, filters, cardiac_filters, preEventPlot_sec, postEventPlot_sec, comment, name, channelToPlot, CM, OnOff)
...
set(gca, 'XTick', round([-preEventPlot_sec, 0, postEventPlot_sec] * 1000));
set(gca, 'YTick', []);
