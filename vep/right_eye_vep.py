...
folder_name = '/media/ssd/right_eye_vep_simple_10ms_'+str(int(time.time()*1000000.0))
...
folder_name = '/media/ssd/right_eye_ss_vep_30hz_'+str(int(time.time()*1000000.0))
os.makedirs(folder_name)
...
folder_name = '/media/ssd/right_eye_ss_vep_random10hzto40hz_'+str(int(time.time()*1000000.0))
os.makedirs(folder_name)
